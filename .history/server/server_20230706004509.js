...
// const roomstuff=new RoomData({Id:1201,Players:{key:2, value:'laks'}})
// roomstuff.save()
function joined(roomid,playerid, player) { 
    RoomData.findOne({ Id: roomid })
        .then((obj) => {
            ...
            obj.Players.push({key:playerid, player})
            // obj.Players.push({key:playerid, value:player})
            log(221)
