...
function Multiplayer(props) {
    ...
    useEffect(() => {
        socket.on('startit', (wordsarray) => {
            ...
            console.log((typeof (["APPLE", "BANANA", "CHERRY"])))
            //send an array of all small letters
    ...
    // when start is true, emit started, after getting response from started, we call countdown and update words
    // by fetching from backend 
    return (
        <div>
            <div>
                {
