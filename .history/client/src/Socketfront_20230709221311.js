...
function SocketFront(props) {
    ...
    return (
        <div>
            ...
            {/* <Multiplayer /> */}
            <Multiplayer setWords={setWords} setStart={setStart} countdown={countdown} start={start} timerText={timerText} words={words} accuracy={accuracy} wordspm={wordspm} index={index} set/>
        </div>
    )
}
