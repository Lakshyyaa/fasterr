    ...
    return (
        <div>
            ...
            <div ref={maindiv}>
                ...
                <button onClick={() => countdown()} disabled={start}>fake button</button>
                <h1>WPM: {wordspm}</h1>
                <h1>Accuracy: {accuracy}%</h1>
            </div>
            {/* <Multiplayer /> */}
            <Multiplayer setStart={setStart} countdown={countdown} start={start} timerText={timerText} words={words} accuracy={accuracy} wordspm={wordspm} index={index} />
        </div>
    )
}
